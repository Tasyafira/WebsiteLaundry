        ...
        <table>
          ...
          <tbody>
            ...
            <tr>              
                ...
                <td><center><?=$data_transaksi['id_member']?><center></td> 
                ...
                <td><center>
                  ...
                  <a href="ubah_transaksi1.php?id_transaksi=<?=$data_transaksi['id_transaksi']?>" class="btn btn-success">Update</a> | 
                  <a href="tampil_detail_transaksi1.php?id_transaksi=<?php echo $data_transaksi['id_transaksi']?>"><button class="btn btn-primary px-2">Detail</button></a> |
