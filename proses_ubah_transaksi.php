...
if($_POST){
    ...
    if(empty($tgl_bayar)){
        echo "<script>alert('Payment Date tidak boleh kosong');location.href='ubah_transaksi.php';</script>";

    } elseif(empty($status)){
        echo "<script>alert('Status tidak boleh kosong');location.href='ubah_transaksi.php';</script>";

    } elseif(empty($dibayar)){
        echo "<script>alert('Payment Status kelamin tidak boleh kosong');location.href='ubah_transaction.php';</script>";
