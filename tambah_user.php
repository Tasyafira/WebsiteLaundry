          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-12">
                  <h3 class="mb-3"><center>ADD User</center></h3>
                </div>
              </div>
            </div>
            <div class="card-body">
            <form action="proses_tambah_user.php" method="POST" enctype= "multipart/form-data">
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-no-password">Password</label>
                    ...
                    <div>
                      ...
                      &nbsp;
                      <a href = "tampil_user.php" class = "btn btn-warning">Show User</a>
                    </div>
                  </div>
                </div>
                <hr class="my-4" />
