        ...
        if(empty($username)){
            ...
            if(mysqli_num_rows($sql_user)>0){
                ...
                if($dt_login['role']=="Admin"){
                    echo "<script>alert('Success login to your admin account');location.href='Admin.php';</script>";
                }elseif($dt_login['role']=="Kasir"){
                    echo "<script>alert('Success login to your admin account');location.href='Kasir.php';</script>";
                }else{
