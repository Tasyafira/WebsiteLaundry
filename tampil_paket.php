        ...
        <table>
          ...
          <tbody>
            ...
            <tr>              
                ...
                <td><center><?=$data_paket['id_paket']?><center></td> 
                <td><?=$data_paket['jenis']?></td>
                <td><?=$data_paket['deskripsi']?></td> 
                <td><?=$data_paket['harga']?></td> 
                <td><?=$data_paket['foto_paket']?></td> 
                <td><center><a href="ubah_paket.php?id_paket=<?=$data_paket['id_paket']?>" class="btn btn-success">Update</a> | 
                <a href="hapus_paket.php?id_paket=<?=$data_paket['id_paket']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Detele</a></center></td>
            </tr>
